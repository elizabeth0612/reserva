                                            ...
                                            <div class="modal-body">
                                                ...
                                                <input type="hidden" name="id" id="id">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input type="text" class="form-control" id="descuento" name="descuento" placeholder="Enter Name" value="" required>
                                                        </div>
                                                    </div>
...
<script type="text/javascript">
  $(function () {
    ...
    $('body').on('click', '.editPost', function () {
      var id = $(this).data('id');
      $.get("{{ route('cupon.index') }}" +'/' + id +'/edit', function (data) {
