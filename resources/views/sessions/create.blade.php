                            ...
                            <div class="card z-index-0 fadeIn3 fadeInBottom">
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                        <h4 class="text-white font-weight-bolder text-center mt-2 mb-0">Iniciar sesión
                                        </h4>
                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login') }}" class="text-start">
                                        ...
                                        <div class="form-check form-switch d-flex align-items-center my-3">
                                            ...
                                            <label class="form-check-label mb-0 ms-2" for="rememberMe">Recordar contraseña</label>
                                        </div>
                                        ...
                                        <p class="text-sm text-center">
                                            ...
                                            <a href="{{ route('verify') }}"
                                                class="text-primary text-gradient font-weight-bold">¿Olvidaste tu contraseña?
                                            </a>
                                        </p>
                                    </form>
                                </div>
